    ...
    for dir in dirs:
        ...
        if config.imshow:
            ...
            for integration_method in config.integration_methods:
                ...
                height_map = shape.get_surface(
                    surface_normals=surface_normals,
                    integration_method=integration_method,
                )
                shape.display_output(
                    albedo_image=albedo_image, height_map=height_map)
        break
    return
